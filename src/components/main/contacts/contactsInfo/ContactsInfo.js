...
function ContactsInfo() {
    return (
        <div className={styles.contactsInfo}>
            <div className={styles.style_contactsInfo__inner}>
                ...
                <div className={styles.contactsInfo__item}>
                    ...
                    <div className={styles.contactsInfo__data}>
                        ...
                        <a href='mailto:chernov.alexey.zel@gmail.com' className={styles.contactsInfo__text} rel="noopener noreferrer">
                            <p>chernov.alexey.zel@gmail.com</p>
                        </a>
                    </div>
                </div>
                <div className={styles.contactsInfo__item}>
